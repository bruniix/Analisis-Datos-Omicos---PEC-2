...
Para ello utilizamos el paquete de Bioconductor edgeR, de este podemos utilziar la función cpm() para visualizar los contajes por millón y filtrar. Una función útil del paquete utilizado es la función filterByExpr() la cual realiza el cálculo mencionado anteriormente y simultáneamente seleccióna las filas o genes a seleccionar. ![Documentación paquete en Bioconductor](https://bioconductor.org/packages/release/bioc/vignettes/edgeR/inst/doc/edgeRUsersGuide.pdf)
...
cat("\n Habiendo filtrado los genes con una menor o nula expresión nos queda el siguiente resumend el objeto:|n")
...
cat("Utilizamos la función decidetest() para ver que genes está sobreexpresados o por debajo para ambas comparaciones. Establecemos los parametros lfc a 1.5 y p.value a 0.05 \n")
